...
if __name__ == '__main__':
    ...
    b, g, r = cv2.split(img)
    g_gaussian = retinex.multi_scale_retinex(g, [15, 80, 250])
    cv2.imshow('g_gaussian', g_gaussian)
    b_gaussian = retinex.multi_scale_retinex(b, [15, 80, 250])
    cv2.imshow('b_gaussian', g_gaussian)
    r_gaussian = retinex.multi_scale_retinex(r, [15, 80, 250])
